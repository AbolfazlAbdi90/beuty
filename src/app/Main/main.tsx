  ...
  return (
    ...
    <img className="md:ml-[560px]" src="/image/image-in-main/logo-inside-container/Vector 8.png" alt="" />
      ...
      <div className="grid grid-cols-1 justify-center md:grid-cols-2 mt-15 gap-8 ">
        <img className=" w-full h-[166px] md:w-full " src="/image/image-in-main/Frame 1261157117.png" alt="image-in-main" />
        <div className="flex md:justify-end">
                  <img className=" h-[166px] md:w-full" src="/image/image-in-main/Frame 1261157116.png" alt="image-in-main" />
